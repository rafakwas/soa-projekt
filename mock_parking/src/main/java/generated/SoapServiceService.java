 ...
 * 
 */
@WebServiceClient(name = "SoapServiceService", targetNamespace = "http://soap/", wsdlLocation = "http://localhost:8080/main_receiver/SoapService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/main_receiver/SoapService?wsdl");
